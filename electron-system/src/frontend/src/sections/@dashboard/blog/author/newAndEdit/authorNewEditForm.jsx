...
AuthorNewEditForm.propTypes = {
  isEdit: PropTypes.bool,
  currentProduct: PropTypes.object,
}

export default function AuthorNewEditForm({isEdit, currentProduct}) {
  ...
  const NewProductSchema = Yup.object().shape({
    name: Yup.string().nullable().required('اسم محصول اجباری است'),
    description: Yup.string().nullable().required('توضیحات محصول اجباری است'),
