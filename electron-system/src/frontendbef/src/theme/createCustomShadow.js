...
import palette from "./palette"; // Ensure you have your palette defined

const createCustomShadow = (color) => {
	const transparent = alpha(color, 0.16); // Change the alpha value as needed
...
export default createCustomShadow;
