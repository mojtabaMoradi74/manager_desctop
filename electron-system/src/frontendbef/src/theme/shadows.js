...
const gray500 = getComputedStyle(document.documentElement).getPropertyValue("--gray-500").trim().replace(/\s+/g, ",");
...
const createCustomShadow = (color) => {
	console.log({ aa: color, aaaaaa: document.documentElement });
