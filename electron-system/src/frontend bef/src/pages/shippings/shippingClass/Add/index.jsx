...
import shippingMethodSelector from '../../shippingMethod/selector'
...
const Add = ({onClose}) => {
  ...
  const onSuccess = (response) => {
    ...
    const resetData = {
      ...
      [validation.fieldNames.shippingMethods]: shippingMethodSelector.convertor.array(
  ...
  const onSubmit = async () => {
    ...
    const reqData = {
      ...
      [validation.fieldNames.shippingMethods]: values[validation.fieldNames.shippingMethods]?.map(
        (x) => x.value
      ),
    }
              ...
              >
                <Grid container spacing={5}>
                  ...
                  <Grid item xs={12} md={12}>
                    <RHFTextField
                      required
                      name={validation.fieldNames.order}
                      label={'order'}
                      type={'number'}
                    />
                  </Grid>
            ...
            <>
              ...
              <FormItem label={t('select')}>
                <Grid container spacing={4}>
                  <Grid item xs={12} md={12}>
                    <shippingMethodSelector.Element
                      name={validation.fieldNames.shippingMethods}
