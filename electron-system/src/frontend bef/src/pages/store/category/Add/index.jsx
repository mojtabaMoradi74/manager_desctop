...
const Add = ({onClose}) => {
  ...
  const onSuccess = (response) => {
    ...
    const resetData = {
      ...
      [validation.fieldNames.parent]: categorySelector.convertor.object(params.parentCategory),
  ...
  const onSubmit = async () => {
    ...
    const reqData = {
      ...
      [validation.fieldNames.parent]: values[validation.fieldNames.parent]?.value,
    }
                ...
                <Grid container spacing={4}>
                  <Grid item xs={12} md={12}>
                    <categorySelector.Element
                      name={validation.fieldNames.parent}
                      label={'parent'}
                    />
                  </Grid>
                  <Grid item xs={12} md={12}>
